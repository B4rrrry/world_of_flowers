...
class Loader
{
   ...
   */
  public static function UploadFile($uploadPath, $senderName, $fileStorage)
  {
    ...
    try {
      ...
      if (isset($_POST[$senderName])) {
        ...
        $fileName = $_FILES[$fileStorage]['name'];
        $fileTmpName = $_FILES[$fileStorage]['tmp_name'];
        $fileSize = $_FILES[$fileStorage]['size'];
        $errors = $_FILES[$fileStorage]['error'];
